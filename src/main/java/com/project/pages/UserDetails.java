...
public class UserDetails extends BaseClass {
        ...
        try {
            ...
            if(txtHeader.getText().equals("Create an account")){
                ...
                if(txtEmailId.getAttribute("value").equals(getValue("EmailId"))){
                    ...
                    //tests.log(Status.PASS,"Login Success", MediaEntityBuilder.createScreenCaptureFromPath(ssPath).build());
                    tests.log(Status.PASS,"Login Success");
                }
                else {
            ...
            e.printStackTrace();
            //tests.log(Status.FAIL,"Login Not Success", MediaEntityBuilder.createScreenCaptureFromPath(ssPath).build());
            tests.log(Status.FAIL,"Login Not Success");
        }
    }
    ...
    public void zipCodeValidation() throws InterruptedException {
    ...
    public void signInInvalidUser() throws InterruptedException {
        linkSignIn.click();
        waitForPageLoad();
        inputUserEmailId.sendKeys(getValue("EmailId"));
